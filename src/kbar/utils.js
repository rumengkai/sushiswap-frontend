...
export const getTotalLPWethValue = async (
  ...
  const tokenAmountWholeLP = 12 // await tokenContract.methods.balanceOf(lpContract.options.address).call()
...
export const stake = async (masterChefContract, pid, amount, account) => {
  ...
  console.log(
    'amount 2:',
    BigNumber(amount).times(new BigNumber(10).pow(18)).toString(),
  )
